 ...
 * @version
 */
public class FragEmPlanCover2_1_1ListViewAdapter extends BaseAdapter {
	 ...
	 *            view的id
	 */
	public FragEmPlanCover2_1_1ListViewAdapter(Context context,
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (!isExpand) {
			...
			switch (position) {
			case 0:
				initCover2_1_1_1Data(holder);
				break;
			case 1:
				initCover2_1_1_2Data(holder);
				break;
			case 2:
				initCover2_1_1_3Data(holder);
				break;
			case 3:
				initCover2_1_1_4Data(holder);
				break;
			case 4:
				initCover2_1_1_5Data(holder);
				break;
			}
		}
		...
		holder.itemsExpand.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				FragEmPlanCover2_1_1ListViewAdapter.this.notifyDataSetChanged();
	...
	private void initCover2_1_1_1Data(final ViewHolder holder) {
		// TODO Auto-generated method stub
		...
		item.callback=new AbHttpCallback() {
			...
			public void update() {
				...
				updateCover2_1_1_1View(view,application.emPlanCover);
			}
			...
			public void get() {
				...
				if(application.emPlanCover.getText2_1_1_1()==null || application.emPlanCover.getText2_1_1_1().equals(""))
				{
					application.emPlanCover.setText2_1_1_1(emPlanCoverService.getEmPlanCover2_1_1_1());
				}
			}
		};
	...
	protected void updateCover2_1_1_1View(View view,
			EmPlanCover emPlanCover) {
		// TODO Auto-generated method stub
		TextView tview = (TextView) view.findViewById(R.id.tv_content);
		tview.setText(emPlanCover.getText2_1_1_1());
	}

	private void initCover2_1_1_2Data(final ViewHolder holder) {
		// TODO Auto-generated method stub
		LinearLayout layout = (LinearLayout) holder.itemsLayoutExpand
				.findViewById(R.id.frag_items_expand);
		((ViewGroup) layout).removeAllViews();
		...
		item.callback=new AbHttpCallback() {
			...
			public void update() {
				// TODO Auto-generated method stub
				ChmApplication application = (ChmApplication) ((FragmentActivity)mContext).getApplication();
				updateCover2_1_1_2View(view,application.emPlanCover);
			}
			...
			public void get() {
				...
				if(application.emPlanCover.getText2_1_1_2()==null || application.emPlanCover.getText2_1_1_2().equals(""))
				{
					application.emPlanCover.setText2_1_1_2(emPlanCoverService.getEmPlanCover2_1_1_2());
				}
			}
		};
	...
	protected void updateCover2_1_1_2View(View view,
			EmPlanCover emPlanCover) {
		// TODO Auto-generated method stub
		TextView tview = (TextView) view.findViewById(R.id.tv_content);
		tview.setText(emPlanCover.getText2_1_1_2());
	}
	private void initCover2_1_1_3Data(final ViewHolder holder) {
		// TODO Auto-generated method stub
		LinearLayout layout = (LinearLayout) holder.itemsLayoutExpand
				.findViewById(R.id.frag_items_expand);
		((ViewGroup) layout).removeAllViews();
		...
		item.callback=new AbHttpCallback() {
			...
			public void update() {
				// TODO Auto-generated method stub
				ChmApplication application = (ChmApplication) ((FragmentActivity)mContext).getApplication();
				updateCover2_1_1_3View(view,application.emPlanCover);
			}
			...
			public void get() {
				...
				if(application.emPlanCover.getText2_1_1_3()==null || application.emPlanCover.getText2_1_1_3().equals(""))
				{
					application.emPlanCover.setText2_1_1_3(emPlanCoverService.getEmPlanCover2_1_1_3());
				}
			}
		};
	...
	protected void updateCover2_1_1_3View(View view,
			EmPlanCover emPlanCover) {
		// TODO Auto-generated method stub
		TextView tview = (TextView) view.findViewById(R.id.tv_content);
		tview.setText(emPlanCover.getText2_1_1_3());
	}
	private void initCover2_1_1_4Data(final ViewHolder holder) {
		// TODO Auto-generated method stub
		LinearLayout layout = (LinearLayout) holder.itemsLayoutExpand
				.findViewById(R.id.frag_items_expand);
		((ViewGroup) layout).removeAllViews();
		...
		item.callback=new AbHttpCallback() {
			...
			public void update() {
				// TODO Auto-generated method stub
				ChmApplication application = (ChmApplication) ((FragmentActivity)mContext).getApplication();
				updateCover2_1_1_4View(view,application.emPlanCover);
			}
			...
			public void get() {
				...
				if(application.emPlanCover.getText2_1_1_4()==null || application.emPlanCover.getText2_1_1_4().equals(""))
				{
					application.emPlanCover.setText2_1_1_4(emPlanCoverService.getEmPlanCover2_1_1_4());
				}
			}
		};
	...
	protected void updateCover2_1_1_4View(View view,
			EmPlanCover emPlanCover) {
		// TODO Auto-generated method stub
		TextView tview = (TextView) view.findViewById(R.id.tv_content);
		tview.setText(emPlanCover.getText2_1_1_4());
	}
	private void initCover2_1_1_5Data(final ViewHolder holder) {
		// TODO Auto-generated method stub
		LinearLayout layout = (LinearLayout) holder.itemsLayoutExpand
				.findViewById(R.id.frag_items_expand);
		((ViewGroup) layout).removeAllViews();
		...
		item.callback=new AbHttpCallback() {
			...
			public void update() {
				// TODO Auto-generated method stub
				ChmApplication application = (ChmApplication) ((FragmentActivity)mContext).getApplication();
				updateCover2_1_1_5View(view,application.emPlanCover);
			}
			...
			public void get() {
				...
				if(application.emPlanCover.getText2_1_1_5()==null || application.emPlanCover.getText2_1_1_5().equals(""))
				{
					application.emPlanCover.setText2_1_1_5(emPlanCoverService.getEmPlanCover2_1_1_5());
				}
			}
		};
	...
	protected void updateCover2_1_1_5View(View view,
			EmPlanCover emPlanCover) {
		// TODO Auto-generated method stub
		TextView tview = (TextView) view.findViewById(R.id.tv_content);
		tview.setText(emPlanCover.getText2_1_1_5());
	}
