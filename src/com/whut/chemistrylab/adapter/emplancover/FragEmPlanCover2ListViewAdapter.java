...
import com.whut.chemistrylab.EmPlanCover2_2TabActivity;
import com.whut.chemistrylab.EmPlanCover2_3TabActivity;
 ...
 * @version
 */
public class FragEmPlanCover2ListViewAdapter extends BaseAdapter {
	 ...
	 *            view的id
	 */
	public FragEmPlanCover2ListViewAdapter(Context context,
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (!isExpand) {
			...
			switch (position) {
			case 0:
				initCover2_1Data(holder);
				break;
			case 1:
				initCover2_2Data(holder);
				break;
			case 2:
				initCover2_3Data(holder);
				break;
			}
		}
		...
		holder.itemsExpand.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				FragEmPlanCover2ListViewAdapter.this.notifyDataSetChanged();
	...
	private void initCover2_1Data(final ViewHolder holder) {
		// TODO Auto-generated method stub
		...
		item.callback=new AbHttpCallback() {
			...
			public void update() {
				...
				updateCover2_1View(view,application.emPlanCover);
			}
			...
			public void get() {
				...
				if(application.emPlanCover.getText2_1()==null || application.emPlanCover.getText2_1().equals(""))
				{
					application.emPlanCover.setText2_1(emPlanCoverService.getEmPlanCover2_1());
				}
			}
		};
	...
	protected void updateCover2_1View(View view,
			EmPlanCover emPlanCover) {
		// TODO Auto-generated method stub
		TextView tview = (TextView) view.findViewById(R.id.tv_content);
		tview.setText(emPlanCover.getText2_1());
		tview.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent it=new Intent(mContext,EmPlanCover2_1TabActivity.class);
	...
	private void initCover2_2Data(final ViewHolder holder) {
		// TODO Auto-generated method stub
		LinearLayout layout = (LinearLayout) holder.itemsLayoutExpand
				.findViewById(R.id.frag_items_expand);
		((ViewGroup) layout).removeAllViews();
		...
		item.callback=new AbHttpCallback() {
			...
			public void update() {
				// TODO Auto-generated method stub
				ChmApplication application = (ChmApplication) ((FragmentActivity)mContext).getApplication();
				updateCover2_2View(view,application.emPlanCover);
			}
			...
			public void get() {
				...
				if(application.emPlanCover.getText2_2()==null || application.emPlanCover.getText2_2().equals(""))
				{
					application.emPlanCover.setText2_2(emPlanCoverService.getEmPlanCover2_2());
				}
			}
		};
	...
	protected void updateCover2_2View(View view,
			EmPlanCover emPlanCover) {
		// TODO Auto-generated method stub
		TextView tview = (TextView) view.findViewById(R.id.tv_content);
		tview.setText(emPlanCover.getText2_2());
		tview.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent it=new Intent(mContext,EmPlanCover2_2TabActivity.class);
				mContext.startActivity(it);
			}
		});
	}

	private void initCover2_3Data(final ViewHolder holder) {
		// TODO Auto-generated method stub
		LinearLayout layout = (LinearLayout) holder.itemsLayoutExpand
				.findViewById(R.id.frag_items_expand);
		((ViewGroup) layout).removeAllViews();
		...
		item.callback=new AbHttpCallback() {
			...
			public void update() {
				// TODO Auto-generated method stub
				ChmApplication application = (ChmApplication) ((FragmentActivity)mContext).getApplication();
				updateCover2_3View(view,application.emPlanCover);
			}
			...
			public void get() {
				...
				if(application.emPlanCover.getText2_3()==null || application.emPlanCover.getText2_3().equals(""))
				{
					application.emPlanCover.setText2_3(emPlanCoverService.getEmPlanCover2_3());
				}
			}
		};
	...
	protected void updateCover2_3View(View view,
			EmPlanCover emPlanCover) {
		// TODO Auto-generated method stub
		TextView tview = (TextView) view.findViewById(R.id.tv_content);
		tview.setText(emPlanCover.getText2_3());
		tview.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent it=new Intent(mContext,EmPlanCover2_3TabActivity.class);
				mContext.startActivity(it);
			}
		});
