 ...
 * @version
 */
public class FragEmPlanCover1ListViewAdapter extends BaseAdapter {
	 ...
	 *            view的id
	 */
	public FragEmPlanCover1ListViewAdapter(Context context,
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (!isExpand) {
			...
			switch (position) {
			case 0:
				initCover1_1Data(holder);
				break;
			case 1:
				initCover1_2Data(holder);
				break;
			}
		}
		...
		holder.itemsExpand.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				FragEmPlanCover1ListViewAdapter.this.notifyDataSetChanged();
	...
	private void initCover1_1Data(final ViewHolder holder) {
		// TODO Auto-generated method stub
		...
		item.callback=new AbHttpCallback() {
			...
			public void update() {
				...
				updateCover1_1View(view,application.emPlanCover);
			}
			...
			public void get() {
				...
				if(application.emPlanCover.getText1_1()==null || application.emPlanCover.getText1_1().equals(""))
				{
					application.emPlanCover.setText1_1(emPlanCoverService.getEmPlanCover1_1());
				}
			}
		};
	...
	protected void updateCover1_1View(View view,
			EmPlanCover emPlanCover) {
		// TODO Auto-generated method stub
		TextView tview = (TextView) view.findViewById(R.id.tv_content);
		tview.setText(emPlanCover.getText1_1());
	}

	private void initCover1_2Data(final ViewHolder holder) {
		// TODO Auto-generated method stub
		LinearLayout layout = (LinearLayout) holder.itemsLayoutExpand
				.findViewById(R.id.frag_items_expand);
		((ViewGroup) layout).removeAllViews();
		...
		item.callback=new AbHttpCallback() {
			...
			public void update() {
				// TODO Auto-generated method stub
				ChmApplication application = (ChmApplication) ((FragmentActivity)mContext).getApplication();
				updateCover1_2View(view,application.emPlanCover);
			}
			...
			public void get() {
				...
				if(application.emPlanCover.getText1_2()==null || application.emPlanCover.getText1_2().equals(""))
				{
					application.emPlanCover.setText1_2(emPlanCoverService.getEmPlanCover1_2());
				}
			}
		};
	...
	protected void updateCover1_2View(View view,
			EmPlanCover emPlanCover) {
		// TODO Auto-generated method stub
		TextView tview = (TextView) view.findViewById(R.id.tv_content);
		tview.setText(emPlanCover.getText1_2());
	}
