 ...
 * @version
 */
public class FragEmPlanCover3_1ListViewAdapter extends BaseAdapter {
	 ...
	 *            view的id
	 */
	public FragEmPlanCover3_1ListViewAdapter(Context context,
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (!isExpand) {
			...
			switch (position) {
			case 0:
				initCover3_1_1Data(holder);
				break;
			case 1:
				initCover3_1_2Data(holder);
				break;
			case 2:
				initCover3_1_3Data(holder);
				break;
			}
		}
		...
		holder.itemsExpand.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				FragEmPlanCover3_1ListViewAdapter.this.notifyDataSetChanged();
	...
	private void initCover3_1_1Data(final ViewHolder holder) {
		// TODO Auto-generated method stub
		...
		item.callback=new AbHttpCallback() {
			...
			public void update() {
				...
				updateCover3_1_1View(view,application.emPlanCover);
			}
			...
			public void get() {
				...
				if(application.emPlanCover.getText3_1_1()==null || application.emPlanCover.getText3_1_1().equals(""))
				{
					application.emPlanCover.setText3_1_1(emPlanCoverService.getEmPlanCover3_1_1());
				}
			}
		};
	...
	protected void updateCover3_1_1View(View view,
			EmPlanCover emPlanCover) {
		// TODO Auto-generated method stub
		TextView tview = (TextView) view.findViewById(R.id.tv_content);
		tview.setText(emPlanCover.getText3_1_1());
	}
	private void initCover3_1_2Data(final ViewHolder holder) {
		// TODO Auto-generated method stub
		LinearLayout layout = (LinearLayout) holder.itemsLayoutExpand
				.findViewById(R.id.frag_items_expand);
		((ViewGroup) layout).removeAllViews();
		...
		item.callback=new AbHttpCallback() {
			...
			public void update() {
				// TODO Auto-generated method stub
				ChmApplication application = (ChmApplication) ((FragmentActivity)mContext).getApplication();
				updateCover3_1_2View(view,application.emPlanCover);
			}
			...
			public void get() {
				...
				if(application.emPlanCover.getText3_1_2()==null || application.emPlanCover.getText3_1_2().equals(""))
				{
					application.emPlanCover.setText3_1_2(emPlanCoverService.getEmPlanCover3_1_2());
				}
			}
		};
	...
	protected void updateCover3_1_2View(View view,
			EmPlanCover emPlanCover) {
		// TODO Auto-generated method stub
		TextView tview = (TextView) view.findViewById(R.id.tv_content);
		tview.setText(emPlanCover.getText3_1_2());
	}

	private void initCover3_1_3Data(final ViewHolder holder) {
		// TODO Auto-generated method stub
		LinearLayout layout = (LinearLayout) holder.itemsLayoutExpand
				.findViewById(R.id.frag_items_expand);
		((ViewGroup) layout).removeAllViews();
		...
		item.callback=new AbHttpCallback() {
			...
			public void update() {
				// TODO Auto-generated method stub
				ChmApplication application = (ChmApplication) ((FragmentActivity)mContext).getApplication();
				updateCover3_1_3View(view,application.emPlanCover);
			}
			...
			public void get() {
				...
				if(application.emPlanCover.getText3_1_3()==null || application.emPlanCover.getText3_1_3().equals(""))
				{
					application.emPlanCover.setText3_1_3(emPlanCoverService.getEmPlanCover3_1_3());
				}
			}
		};
	...
	protected void updateCover3_1_3View(View view,
			EmPlanCover emPlanCover) {
		// TODO Auto-generated method stub
		TextView tview = (TextView) view.findViewById(R.id.tv_content);
		tview.setText(emPlanCover.getText3_1_3());
	}
