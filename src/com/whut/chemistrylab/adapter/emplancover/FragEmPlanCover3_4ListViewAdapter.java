 ...
 * @version
 */
public class FragEmPlanCover3_4ListViewAdapter extends BaseAdapter {
	 ...
	 *            view的id
	 */
	public FragEmPlanCover3_4ListViewAdapter(Context context,
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (!isExpand) {
			...
			switch (position) {
			case 0:
				initCover3_4_1Data(holder);
				break;
			case 1:
				initCover3_4_2Data(holder);
				break;
			}
		}
		...
		holder.itemsExpand.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				FragEmPlanCover3_4ListViewAdapter.this.notifyDataSetChanged();
	...
	private void initCover3_4_1Data(final ViewHolder holder) {
		// TODO Auto-generated method stub
		...
		item.callback=new AbHttpCallback() {
			...
			public void update() {
				...
				updateCover3_4_1View(view,application.emPlanCover);
			}
			...
			public void get() {
				...
				if(application.emPlanCover.getText3_4_1()==null || application.emPlanCover.getText3_4_1().equals(""))
				{
					application.emPlanCover.setText3_4_1(emPlanCoverService.getEmPlanCover3_4_1());
				}
			}
		};
	...
	protected void updateCover3_4_1View(View view,
			EmPlanCover emPlanCover) {
		// TODO Auto-generated method stub
		TextView tview = (TextView) view.findViewById(R.id.tv_content);
		tview.setText(emPlanCover.getText3_4_1());
	}

	private void initCover3_4_2Data(final ViewHolder holder) {
		// TODO Auto-generated method stub
		LinearLayout layout = (LinearLayout) holder.itemsLayoutExpand
				.findViewById(R.id.frag_items_expand);
		((ViewGroup) layout).removeAllViews();
		...
		item.callback=new AbHttpCallback() {
			...
			public void update() {
				// TODO Auto-generated method stub
				ChmApplication application = (ChmApplication) ((FragmentActivity)mContext).getApplication();
				updateCover3_4_2View(view,application.emPlanCover);
			}
			...
			public void get() {
				...
				if(application.emPlanCover.getText3_4_2()==null || application.emPlanCover.getText3_4_2().equals(""))
				{
					application.emPlanCover.setText3_4_2(emPlanCoverService.getEmPlanCover3_4_2());
				}
			}
		};
	...
	protected void updateCover3_4_2View(View view,
			EmPlanCover emPlanCover) {
		// TODO Auto-generated method stub
		TextView tview = (TextView) view.findViewById(R.id.tv_content);
		tview.setText(emPlanCover.getText3_4_2());
	}
