 ...
 * @version
 */
public class FragEmPlanCover2_2ListViewAdapter extends BaseAdapter {
	 ...
	 *            view的id
	 */
	public FragEmPlanCover2_2ListViewAdapter(Context context,
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (!isExpand) {
			...
			switch (position) {
			case 0:
				initCover2_2_1Data(holder);
				break;
			case 1:
				initCover2_2_2Data(holder);
				break;
			}
		}
		...
		holder.itemsExpand.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				FragEmPlanCover2_2ListViewAdapter.this.notifyDataSetChanged();
	...
	private void initCover2_2_1Data(final ViewHolder holder) {
		// TODO Auto-generated method stub
		...
		item.callback=new AbHttpCallback() {
			...
			public void update() {
				...
				updateCover2_2_1View(view,application.emPlanCover);
			}
			...
			public void get() {
				...
				if(application.emPlanCover.getText2_2_1()==null || application.emPlanCover.getText2_2_1().equals(""))
				{
					application.emPlanCover.setText2_2_1(emPlanCoverService.getEmPlanCover2_2_1());
				}
			}
		};
	...
	protected void updateCover2_2_1View(View view,
			EmPlanCover emPlanCover) {
		// TODO Auto-generated method stub
		TextView tview = (TextView) view.findViewById(R.id.tv_content);
		tview.setText(emPlanCover.getText2_2_1());
	}

	private void initCover2_2_2Data(final ViewHolder holder) {
		// TODO Auto-generated method stub
		LinearLayout layout = (LinearLayout) holder.itemsLayoutExpand
				.findViewById(R.id.frag_items_expand);
		((ViewGroup) layout).removeAllViews();
		...
		item.callback=new AbHttpCallback() {
			...
			public void update() {
				// TODO Auto-generated method stub
				ChmApplication application = (ChmApplication) ((FragmentActivity)mContext).getApplication();
				updateCover2_2_2View(view,application.emPlanCover);
			}
			...
			public void get() {
				...
				if(application.emPlanCover.getText2_2_2()==null || application.emPlanCover.getText2_2_2().equals(""))
				{
					application.emPlanCover.setText2_2_2(emPlanCoverService.getEmPlanCover2_2_2());
				}
			}
		};
	...
	protected void updateCover2_2_2View(View view,
			EmPlanCover emPlanCover) {
		// TODO Auto-generated method stub
		TextView tview = (TextView) view.findViewById(R.id.tv_content);
		tview.setText(emPlanCover.getText2_2_2());
	}
