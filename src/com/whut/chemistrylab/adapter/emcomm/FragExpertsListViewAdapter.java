 ...
 * @version
 */
public class FragExpertsListViewAdapter extends BaseAdapter {
	 ...
	 */
	public FragExpertsListViewAdapter(Context context,
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		holder.itemsCheck.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				FragExpertsListViewAdapter.this.notifyDataSetChanged();
	...
	private void initExpertsData(final ViewHolder holder,final Integer id) {
		// TODO Auto-generated method stub
		...
		item.callback=new AbHttpCallback() {
			...
			public void update() {
				// TODO Auto-generated method stub
				updateinitExpertsView(view,experts);
			}
	...
	private void updateinitExpertsView(View view, Experts experts) {
		// TODO Auto-generated method stub
