...
import com.whut.chemistrylab.adapter.emcomm.FragEmMemberListViewAdapter.ViewHolder;
 ...
 * @version
 */
public class FragHeadquatersListViewAdapter extends BaseAdapter {
	...
	Headquaters experts=null;
	HeadquatersDao expertsDao=null;
	 ...
	 */
	public FragHeadquatersListViewAdapter(Context context,
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (!isExpand) {
			...
			//设置expand layout数据
			initHeadquatersData(holder,_id);
		}
		...
		holder.itemsExpand.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				FragHeadquatersListViewAdapter.this.notifyDataSetChanged();
	...
	private void initHeadquatersData(final ViewHolder holder,final Integer id) {
		// TODO Auto-generated method stub
		...
		item.callback=new AbHttpCallback() {
			...
			public void update() {
				// TODO Auto-generated method stub
				updateinitHeadquatersView(view,experts);
			}
	...
	private void updateinitHeadquatersView(View view, Headquaters experts) {
		// TODO Auto-generated method stub
