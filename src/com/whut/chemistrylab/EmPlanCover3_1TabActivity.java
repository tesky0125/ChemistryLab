...
import com.whut.chemistrylab.emplancover.Fragment_EmPlanCover3_1;
import com.whut.chemistrylab.global.ChmApplication;

public class EmPlanCover3_1TabActivity extends AbActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Fragment_EmPlanCover3_1 page1 = new Fragment_EmPlanCover3_1();//
		
		List<Fragment> mFragments = new ArrayList<Fragment>();
		mFragments.add(page1);
		
		List<String> tabTexts = new ArrayList<String>();
		tabTexts.add("Î£ÏÕÆ·Ð¹Â¶ÊÂ¹Ê±¨¸æ");
