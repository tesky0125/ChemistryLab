...
import com.whut.chemistrylab.emplancover.Fragment_EmPlanCover2_2;
import com.whut.chemistrylab.emplancover.Fragment_EmPlanCover3;
import com.whut.chemistrylab.global.ChmApplication;

public class EmPlanCover2_2TabActivity extends AbActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Fragment_EmPlanCover2_2 page1 = new Fragment_EmPlanCover2_2();//
		
		List<Fragment> mFragments = new ArrayList<Fragment>();
		mFragments.add(page1);
		
		List<String> tabTexts = new ArrayList<String>();
		tabTexts.add("队伍与设备器材");
