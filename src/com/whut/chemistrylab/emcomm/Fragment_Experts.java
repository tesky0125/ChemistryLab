...
import com.whut.chemistrylab.adapter.emcomm.FragExpertsListViewAdapter;
...
public class Fragment_Experts extends Fragment implements IInFragmentCallback {
	...
	private FragExpertsListViewAdapter myListViewAdapter;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		expertsListService=new ExpertsListService(mActivity);
		expertsDao = new ExpertsDao(mActivity);
		...
		// 使用自定义的Adapter
        myListViewAdapter = new FragExpertsListViewAdapter(mActivity, listdata,
...
//System.out.println(_id);
	...
	private List<String> getCheckedPhones()
	{
		...
		for(Map<String,Object> map : listdata)
		{
			...
			Integer _id=(Integer) map.get("_id");
			Experts experts = expertsDao.getBeanByID(_id);
			if(isCheck) 
...
//System.out.println("expertsListService--newListdata"+newListdata.size());	   		    	
