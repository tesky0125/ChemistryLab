...
import com.whut.chemistrylab.emplancover.Fragment_EmPlanCover3_4;
import com.whut.chemistrylab.global.ChmApplication;

public class EmPlanCover3_4TabActivity extends AbActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Fragment_EmPlanCover3_4 page1 = new Fragment_EmPlanCover3_4();//
		
		List<Fragment> mFragments = new ArrayList<Fragment>();
		mFragments.add(page1);
		
		List<String> tabTexts = new ArrayList<String>();
		tabTexts.add("Œ£œ’∆∑–π¬∂º‡ ””Îº‡≤‚");
